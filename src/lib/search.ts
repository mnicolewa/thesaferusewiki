...
const BASE_ENTRIES: SearchEntry[] = [
  ...
  },
  {
    ...
    section: "Tools",
    description: "Look up a medication by barcode, UPC, or NDC and review recalls, warnings, and label details.",
    keywords: [
      "barcode",
      "ndc",
      "upc",
  ...
  },
  {
    id: "support-overview",
    href: "#support",
    title: "Find Naloxone, Treatment, and Syringe Services",
    section: "Support",
    description: "Find nearby naloxone access, treatment centers, and syringe services by ZIP code.",
    keywords: [
      "naloxone near me",
      "find help",
      "treatment locator",
